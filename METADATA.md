...
### EXIF
*Exchangeable Image File Format* (Criado em 1998)
...
### XMP
*Extensible Metadata Platform* (Desenvolvido pela Adobe em 2001)
...
### IPTC
*International Press Telecommunications Council* (Criado nos anos 1970/1990)
...
2. **Zero Analytics de Fotos**: Nenhuma imagem ou metadado é transmitido para servidores de terceiros ou base de dados em nuvem. Todo o processamento termina quando você fecha a guia.
